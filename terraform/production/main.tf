...
resource "aws_ssm_parameter" "authentication_identifier" {
    name  = "/HousingManagementSystemApi/production/authentication-identifier"
    type  = "String"
    value = var.authentication_identifier
}
resource "aws_ssm_parameter" "jwt_secret" {
    name  = "/HousingManagementSystemApi/production/jwt-secret"
    type  = "String"
    value = var.jwt_secret
}
resource "aws_ssm_parameter" "universal_housing_connection_string" {
    name  = "/HousingManagementSystemApi/production/universal-housing-connection-string"
    type  = "String"

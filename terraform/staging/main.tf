...
resource "aws_ssm_parameter" "authentication_identifier" {
    name  = "/HousingManagementSystemApi/staging/authentication-identifier"
    type  = "String"
    value = var.authentication_identifier
}
resource "aws_ssm_parameter" "jwt_secret" {
    name  = "/HousingManagementSystemApi/staging/jwt-secret"
    type  = "String"
    value = var.jwt_secret
}
resource "aws_ssm_parameter" "universal_housing_connection_string" {
    name  = "/HousingManagementSystemApi/staging/universal-housing-connection-string"
    type  = "String"
